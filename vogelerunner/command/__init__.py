...
from vogelerunner import mainmodule
from vogelerunner import loggers
import vogelerunner

CONFDIR=os.path.expanduser('~/vogelerunner')
MODULENAME='vogelerunner'
...
def main():
    ...
    parser = optparse.OptionParser(usage="%prog", version=vogelerunner.__version__)
